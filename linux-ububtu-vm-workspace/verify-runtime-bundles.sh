...
check 093f590ba02b0284dc676d7f8ae499ead6fd93316524f7872cfa3c6fda0660bd 'audio.zip' 'audio(2).zip' || fail=1
check 060c674c9855aee0cb1c14a0e895c8cecfe2fb001a8fee12904956c5951fbb30 'operating-system.zip' || fail=1
check 3a70c1dbdccdf68b766df2c68bcd82e597de7ffafdb8fd2d7f0ec86ffdcad1a2 'packages.zip' 'packages(2).zip' || fail=1
