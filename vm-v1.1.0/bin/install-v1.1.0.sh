...
install -m 0644 "$SRC/config/durable-recovery-v1.1.0.json" "$DEST/config/durable-recovery-v1.1.0.json"
...
install -m 0755 "$SRC/bin/verify-durable-recovery-v1.1.0.py" "$DEST/bin/verify-durable-recovery-v1.1.0.py"
install -m 0755 "$SRC/bin/rehydrate-offline-v1.1.0.py" "$DEST/bin/rehydrate-offline-v1.1.0.py"
install -m 0755 "$SRC/bin/verify-live-certification-v1.1.0.py" "$DEST/bin/verify-live-certification-v1.1.0.py"
...
echo "Installed vm-v1.1.0 gates, durable-recovery verifier, explicit offline rehydrator, live-certification verifier, and launcher files only."
echo "No instrument/model/project bytes were modified by this installer."
